...
function app.SchedulingSystemConfig:getAllowedOrigins()
	do return {
		"http://localhost:8080",
		"http://localhost:8081",
		"http://ec2-13-250-31-192.ap-southeast-1.compute.amazonaws.com:30051"
	} end
end
...
function app.SchedulingSystemDatabase.Riderregistration:setUsername(value)
	self._username = value
	do return self end
end

function app.SchedulingSystemDatabase.Riderregistration:getUsername()
	do return self._username end
end

function app.SchedulingSystemDatabase.Riderregistration:setPassword(value)
	self._password = value
	do return self end
end

function app.SchedulingSystemDatabase.Riderregistration:getPassword()
...
function app.SchedulingSystemApiHandler.RiderregistrationRequest:setId(value)
	self._id = value
	do return self end
end

function app.SchedulingSystemApiHandler.RiderregistrationRequest:getId()
	do return self._id end
end
...
function app.SchedulingSystemApiHandler.RiderregistrationRequest:setUsername(value)
	self._username = value
	do return self end
end

function app.SchedulingSystemApiHandler.RiderregistrationRequest:getUsername()
	do return self._username end
end

function app.SchedulingSystemApiHandler.RiderregistrationRequest:setPassword(value)
	self._password = value
	do return self end
end

function app.SchedulingSystemApiHandler.RiderregistrationRequest:getPassword()
	do return self._password end
end
